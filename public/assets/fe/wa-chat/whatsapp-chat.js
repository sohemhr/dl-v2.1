        ...
        if(settings.selector != ''){
            ...
            if(element !=null){
                var chatBox = '<div class="ayoan_whatsapp_chatbox_container">' +
                    ...
                    '<img class="header-icon" src="img/favicon.ico" style="width:50px"> </div><div class="col col-2">' +
                    '<div class="header-title"> &nbsp;&nbsp; <b>Hallo CS Dokter Legal</b></div><div class="header-content">'+settings.headerMessage+
                    ...
                    '<img class="icon" src="/assets/fe/wa-chat/assets/close.svg"></button></div></div>' +
                    '<div class="rs-openChatBtn widget-close-btn-row" >' +
                    '<button type="button" class="rs-openChatBtn widget-close-btn">' +
                    '<img class="icon" src="/assets/fe/wa-chat/assets/whatsapp.svg"></button></div></div>';
                ...
                for (var i = 0; i < goToWhatsapp.length; i++) {
                    goToWhatsapp[i].addEventListener("click", function(){
                        ...
                        message = "Hello..!! Saya mempunyai pertanyaan tentang Dokter Legal, saya mengetahuinya dari situs https://www.dokterlegal.co.id";
...
function sendWPMessage(phone, message=''){
    if(/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent) ||
      (/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.platform))){
        ...
        apiEndPoint = 'https://wa.me/' + phone + '?text=' + encodeURI(message);
    }else{
        apiEndPoint = 'https://web.whatsapp.com/send?phone=' + phone + '&text=' + encodeURI(message);
    }
