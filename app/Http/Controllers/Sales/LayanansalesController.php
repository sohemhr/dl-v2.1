...
class LayanansalesController extends Controller
{
    public function index()
    {
        ...
        return view('sales.layanan.index', $data);
    }
    ...
    public function show(string $uuid)
    {
        ...
        return view('sales.layanan.detail', $data);
    }
    ...
    public function showJenis(string $uuid, string $jnsuuid)
    {
        ...
        return view('sales.layanan.layanan-jenis', $data);
    }
    ...
    public function indexJenis()
    {
        ...
        return view('sales.layanan.all-jenis', $data);
    }
}
