...
class KategoriController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('user.kategori.create', $data);
    }
    ...
    public function show(string $uuid)
    {
        ...
        return view('user.kategori.edit', $data);
    }
    ...
    public function update(Request $request, string $uuid)
    {
        ...
        return redirect()->route('kategori.index')->with('success', 'Data Kategori telah di perbaharui..');
    }
