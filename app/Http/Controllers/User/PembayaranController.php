...
class PembayaranController extends Controller
{
    ...
    public function create(String $uuid)
    {
        ...
        return view('user.pembayaran.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('transaksi.details', $request->trx_uuid)->with('success', 'Data telah di tambahkan..');
    }
    ...
    public function show(string $uuid)
    {
        ...
        return view('user.pembayaran.edit', $data);
    }
