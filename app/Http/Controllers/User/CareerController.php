...
class CareerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.career.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('user.career.create', $data);
    }
    ...
    public function show(string $uuid)
    {
        ...
        return view('user.career.edit', $data);
    }
    ...
    public function update(Request $request, string $uuid)
    {
        ...
        return redirect()->route('career.index')->with('success', 'Data career telah di perbaharui..');
    }
    /**
