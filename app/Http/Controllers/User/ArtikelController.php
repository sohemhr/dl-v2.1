...
class ArtikelController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('user.artikel.create', $data);
    }
    ...
    public function show(string $uuid)
    {
        ...
        return view('user.artikel.edit', $data);
    }
    ...
    public function update(Request $request, string $uuid)
    {
        ...
        return redirect()->route('artikel.index')->with('success', 'Data Artikel telah di perbaharui..');
    }
    /**
    ...
    {
        $getArtikel = Artikel::orderBy('artikel_kode', 'DESC')->paginate(10);
        $data = [
            'title'     => 'Artikel',
            'subtitle'  => 'Data Artikel',
            'getArtikel' => $getArtikel
        ...
        return view('user.artikel.get-links', $data);
    }
}
