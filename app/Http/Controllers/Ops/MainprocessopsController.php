...
class MainprocessopsController extends Controller
{
    public function start()
    {
        ...
        return view('ops.main-process.start', $data);
    }
    ...
    public function startGetUuid(String $uuid)
    {
        ...
        return view('ops.main-process.startbyuuid', $data);
    }
    ...
    public function updateNotes(Request $request, string $uuid)
    {
        ...
        return redirect()->route('opsmainprocess.startgetuuid', $uuid)->with('success', 'Data telah di perbaharui..');
    }
    ...
    public function startProcess(string $uuid)
    {
        ...
        // Redirect to dashboard
        return redirect()->route('opsmainprocess.onprocessgetuuid', $uuid)->with('success', 'Data telah di perbaharui..');
    }
    ...
    public function onprocessGetUuid(String $uuid)
    {
        ...
        return view('ops.main-process.processbyuuid', $data);
    }
    ...
    public function onProcess()
    {
        ...
        return view('ops.main-process.process', $data);
    }
    ...
    public function completed()
    {
        ...
        return view('ops.main-process.completed', $data);
    }
    ...
    public function completedGetUuid(String $uuid)
    {
        ...
        return view('ops.main-process.completedbyuuid', $data);
    }
