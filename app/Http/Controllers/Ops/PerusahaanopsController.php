...
class PerusahaanopsController extends Controller
{
    public function index()
    {
        ...
        return view('ops.perusahaan.index', $data);
    }
    ...
    public function details(string $uuid)
    {
        ...
        return view('ops.perusahaan.detail', $data);
    }
    ...
    public function indexTransaksi()
    {
        ...
        return view('ops.perusahaan.index-transaksi', $data);
    }
    ...
    public function showTransaksi(string $uuid)
    {
        ...
        return view('ops.perusahaan.edit-transaksi', $data);
    }
    ...
    public function detailsTransaksi(string $uuid)
    {
        ...
        return view('ops.perusahaan.detail-transaksi', $data);
    }
}
