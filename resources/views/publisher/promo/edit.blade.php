            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="/publisher/promo/update/{{ $item->promo_uuid }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 mt-4">
                                        <div>
                                            ...
                                            <img id="frame_images" src="/storage/{{ $item->promo_foto }}" width="400px" height="264px" alt="Image">
                                            @else
