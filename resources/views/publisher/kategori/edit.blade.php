            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="/publisher/kategori/update/{{ $item->kategori_uuid }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="kategori_nama" class="form-control @error('kategori_nama') is-invalid @enderror" id="kategori_nama" placeholder="Nama Kategori" value="{{ $item->kategori_nama }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" name="kategori_warna" class="form-control @error('kategori_warna') is-invalid @enderror" id="kategori_warna" placeholder="Warna Kategori => success" value="{{ $item->kategori_warna }}">
