            ...
            <div class="row">
                ...
                <!-- /.card -->
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="/sales/main-process/onprocess/update/{{ $val->trxdtl_uuid }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-footer text-center">
                                ...
                                <button type="submit" class="btn btn-info float-right">Submit Notes</button>
                            </div>
                            <!-- /.card-footer -->
                        </form>
                        @endforeach
