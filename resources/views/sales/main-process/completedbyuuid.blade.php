            ...
            <div class="row">
                ...
                <!-- /.card -->
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="/admstr/main-process/onprocess/update/{{ $val->trxdtl_uuid }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 mb-4">                                    
                                    <select class="form-control select2" id="trxdtlsts_nama" name="trxdtlsts_nama" required="">
                                        ...
                                        <option value="{{ $inList->lp_nama }}">{{ $noList++.'. '.$inList->lp_nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-2">
        ...
        <div class="modal fade" id="modal-edit{{ $key->trxdtlsts_kode }}" aria-hidden="true">
            <div class="modal-dialog modal-lg">    
                <div class="modal-content">    
                    ...
                    <div class="modal-body">    
                        <form action="/admstr/main-proces/onprocess/updatedetailprocess/status/{{ $key->trxdtlsts_dtl_kode }}" id="editForm" name="editForm" class="form-horizontal" method="POST">  
                            @csrf 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 mb-4">                                    
                                    <select class="form-control select2" id="trxdtlsts_nama" name="trxdtlsts_nama" required="">
                                        <option value="{{ $key->trxdtlsts_nama }}">*{{ $key->trxdtlsts_nama }}</option>
                                        @php
                                            $noList = 1;
                                        @endphp
                                        @foreach ($getListProcess as $inList)
