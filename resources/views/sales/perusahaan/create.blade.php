            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="/sales/perusahaan/store" method="post" enctype="multipart/form-data" name="myForm">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="perusahaan_alamat" class="form-control @error('perusahaan_alamat') is-invalid @enderror" id="perusahaan_alamat" placeholder="Alamat Perusahaan" value="{{ old('perusahaan_alamat') }}" rows="3"></textarea>
                                ...
                                <input type="text" name="kode_user" value="{{ auth('user')->user()->kode }}" hidden>
