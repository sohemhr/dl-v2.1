...
<html lang="id">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="/sales/transaksi/update/{{ $item['trx_uuid'] }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
        ...
        <div class="modal fade" id="modal-delete{{ $key->trxdtl_kode }}">
            <div class="modal-dialog">
                <div class="modal-content bg-white">
                    ...
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <form class="form_delete" action="/sales/brosur/destroypaket/{{ $key->trxdtl_kode }}" method="post">
                            @csrf
                            @method('DELETE')
    ...
    <script>
        ...
        $.ajax(
            {
                url: "/sales/transaksi/destroydtl/"+id,
                type: 'DELETE',
                data: {
                "id": id,
                "_token": token,
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('click', '#edit_jenis_detail', function () {
                ...
                $.get('/sales/transaksi/editjnsdtl/'+trxdtl_kode+'', function (data) {
