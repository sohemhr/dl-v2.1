            ...
            <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">                                       
                                        <td>: 
                                            <b>
                                                <a href="/ops/transaksi/show/{{ $item->trx_uuid }}">
                ...
                <!-- /.card -->
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="/ops/main-process/onprocess/update/{{ $val->trxdtl_uuid }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                        ...
                        <table id="example2" class="table table-bordered table-striped">
                            ...
                            @foreach ($listStsDtl as $sts)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($sts->update_at)->format('d-m-Y') }}</td> 
                                    <td>
                                        <button type="button" class="btn btn-xs btn-success" data-toggle="modal" data-target="#modal-edit{{ $sts->trxdtlsts_kode }}">
                        ...
                        <form id="statusForm" name="statusForm" class="form-horizontal">  
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 mb-4">                                    
                                    <select class="form-control select2" id="trxdtlsts_nama" name="trxdtlsts_nama" required="">
                                        @php
                                            $noList = 1;
                                        @endphp
                                        @foreach ($getListProcess as $inList)
                                        <option value="{{ $inList->lp_kode }}">{{ $noList++.'. '.$inList->lp_nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    <textarea name="trxdtlsts_keterangan" id="trxdtlsts_keterangan" class="form-control" rows="3"></textarea>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="modal-edit{{ $key->trxdtlsts_kode }}" aria-hidden="true">
            <div class="modal-dialog modal-lg">    
                <div class="modal-content">    
                    ...
                    <div class="modal-body">    
                        <form action="/ops/main-proces/onprocess/updatedetailprocess/status/{{ $key->trxdtlsts_dtl_kode }}" id="editForm" name="editForm" class="form-horizontal" method="POST">  
                            @csrf 
                            <input type="text" name="trxdtlsts_kode" id="trxdtlsts_kode" value="{{ $key->trxdtlsts_kode }}" hidden>
                            <div class="row">
                                <div class="col-md-2">
                                    <label for="trxdtlsts_nama" class="control-label">
                                        Process
                                ...
                                <div class="col-md-10">
                                    <textarea name="trxdtlsts_keterangan" id="trxdtlsts_keterangan" class="form-control" rows="3">{{ $key->trxdtlsts_keterangan }}</textarea>
                                </div>
                            ...
                            <div class="col-sm-12 mt-4">  
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>  
                                <button type="submit" class="btn btn-primary  float-right" id="btn-update" value="create">Update   
                                </button>    
                            </div>    
                        </form>    
                    </div>    
        ...
        $(function () {
            ...
            $(this).html('Sending..');
                $.ajax({
                    ...
                    url: "{{ route('opsmainprocess.creatests') }}",
                    type: "POST",
                    dataType: 'json',
