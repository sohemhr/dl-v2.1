            ...
            <div class="row">
                ...
                <!-- /.card -->
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="/ops/main-process/start/update/{{ $val->trxdtl_uuid }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-footer text-right">
                                ...
                                <a href="/ops/main-process/start/startprocess/{{ $val->trxdtl_uuid }}">
