...
@section(section: 'content')
    ...
    <div class="card bg-white border-0 rounded-3 mb-4">
        ...
        <div class="main-content d-flex flex-column">
            ...
            {{-- Seluruh konten dashboard di sini, tanpa tag html/body/head/footer/sidebar/header/section --}}
            {{-- <div class="row">
                <div class="col-md-12">
                    @if (session('success'))
                    <div class="alert alert-success alert-dismissible">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button>
                        <h5><i class="icon fas fa-check"></i> {{ session('success') }} <i class="fa fa-smile"
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3>{{ $total_transaksi->count() }} <code class="text-black">*</code></h3>

                            <h4>{{ $total_trxproses_selesai->count() }} <sup style="font-size: 14px">Selesai</sup></h4>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        <div class="inner">
                            ...
                            <h4>{{ $total_trxbayar_selesai->count() }} <sup style="font-size: 14px">Selesai</sup></h4>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3>{{ $total_transaksi_detail->count() }} <code class="text-white">*</code></h3>

                            <p>Transaksi Process</p>
                        </div>
                        <div class="icon">
                            <i class="fa fa-building"></i>
                        </div>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3>{{ $total_trxdtl_start->count() }} <code class="text-white">*</code></h3>

                            <p>Transaksi Process Start</p>
                        </div>
                        <div class="icon">
                            <i class="fa fa-cogs"></i>
                        </div>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3>{{ $total_trxdtl_onprocess->count() }} <code class="text-black">*</code></h3>

                            <p>Transaksi Process OnProcess</p>
                        </div>
                        <div class="icon">
                            <i class="fa fa-hourglass-half"></i>
                        </div>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3>{{ $total_trxdtl_completed->count() }} <code class="text-white">*</code></h3>

                            <p>Transaksi Process Completed</p>
                        </div>
                        <div class="icon">
                            <i class="fa fa-thumbs-up"></i>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3>{{ $total_trxbayar_tunggu->count() }} <code class="text-white">*</code></h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3>{{ $total_trxbayar_dp->count() }} <code class="text-white">*</code></h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3>{{ $total_trxbayar_dicicil->count() }} <code class="text-black">*</code></h3>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3>{{ $total_trxbayar_lunas->count() }} <code class="text-white">*</code></h3>
