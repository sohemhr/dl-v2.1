                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-info">
                                ...
                                @foreach ($users as $item)
                                    ...
                                    <form class="form-horizontal" action="/admstr/users/update/{{ $item['uuid'] }}"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div>
                                                        @if ($item['foto'] != '')
                                                            <img id="frames" src="/storage/{{ $item['foto'] }}" width="180px"
                                                                alt="User Image">
                                                        @else
                                                            <img id="frames" src="/storage/users_foto/default.png" width="180px"
                                                                alt="User Image">
                                                        @endif
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                @error('password')<span id="password"
                                                class="error invalid-feedback">{{ $message }}</span>@enderror
                                            </div>

                                            <div class="form-group row">
                                                <label for="password_confirmation"
                                                    class="col-sm-2 col-form-label">Confirmation Password</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="no_hp"
                                                        ...
                                                        placeholder="No. Hp." value="{{ $item['no_hp'] }}">
                                                    @error('no_hp')<span id="no_hp"
                                                    class="error invalid-feedback">{{ $message }}</span>@enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="tmp_lahir"
                                                        ...
                                                        value="{{ $item['tmp_lahir'] }}">
                                                    @error('tmp_lahir')<span id="tmp_lahir"
                                                    class="error invalid-feedback">{{ $message }}</span>@enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    @error('tgl_lahir')<span id="tgl_lahir"
                                                    class="error invalid-feedback">{{ $message }}</span>@enderror
                                                </div>
                                            </div>
