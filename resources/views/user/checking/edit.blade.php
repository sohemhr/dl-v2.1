            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        ...
                        {{-- <form class="form-horizontal" action="/admstr/checking/update/{{ $item->chk_uuid }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT') --}}
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" target="_blank" action="/admstr/checking/chats/{{ $item->chk_uuid }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group row">
