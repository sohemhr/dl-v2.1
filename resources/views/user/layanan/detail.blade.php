                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" name="layanan_harga" class="form-control" id="layanan_harga" placeholder="Harga Mulai Dari" value="{{ $item['layanan_harga'] }}" type-currency="IDR" readonly>
                                    </div>
                                </div>
                            ...
                            <table id="example2" class="table table-bordered table-striped">
                                ...
                                @foreach ($roleLayInc as $val)
                                    <tr>
                                        ...
                                        <td>{{ $val->il_nama }}</td> 
                                        <td>
                                            <a href="javascript:void(0)" id="edit_rol_layinc" data-id="{{ $val->rli_kode }}">
                                                <button type="button" class="btn btn-xs btn-success">
                                                    <i class="fa fa-edit" aria-hidden="true"></i>
                                                    &nbsp;Edit
                                                </button>
                                            </a>
                                            <button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#modal-delete{{ $val->rli_kode }}">
                            ...
                            <table id="example3" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/admstr/layanan-jenis/show/{{ $getLayUuid->layanan_uuid }}/{{ $gjl->jenis_uuid }}">
                                            <button type="button" class="btn btn-xs btn-success">
                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                                &nbsp;Edit
                                            </button>
                                        </a>
                                        <button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#modal-deleteJenis{{ $gjl->jenis_kode }}">
                                            <i class="fa fa-trash" aria-hidden="true"></i>                                    
                                        </button>
                                        @endforeach
                                    </td>
                ...
                <div class="modal-content">    
                    ...
                    <div class="modal-body">    
                        <form id="roleLayIncForm" name="roleLayIncForm" class="form-horizontal">  
                            @csrf 
                            <input type="text" name="rli_lay_kode" id="rli_lay_kode" value="{{ $key['layanan_kode'] }}" hidden>
                ...
                <div class="modal-content bg-white">
                    <div class="modal-header bg-danger">
                        ...
                        <form class="form_deleteJenis" action="#" method="post">
                            ...
                            @method('DELETE')
                            <meta name="csrf-token" content="{{ csrf_token() }}">
                            <button type="button" class="btn btn-sm btn-danger deleteRecordJenis" data-idjenis="{{ $xJns->jenis_kode }}">
                                <i class="fa fa-trash"></i> 
                                &nbsp;Hapus
                            </button>
                        </form>                
