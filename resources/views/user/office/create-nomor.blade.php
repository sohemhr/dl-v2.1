            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="/admstr/office/nomor/store/{{ $item->office_uuid }}" method="post" enctype="multipart/form-data" name="myForm">
                            @csrf
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="cn_nama" class="col-sm-2 col-form-label">Nama Pengguna</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="cn_nama" class="form-control @error('cn_nama') is-invalid @enderror" id="cn_nama" placeholder="Nama Pengguna" value="{{ old('cn_nama') }}" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" name="cn_hp" class="form-control @error('cn_hp') is-invalid @enderror" id="cn_hp" placeholder="Nomor handphone" value="{{ old('cn_hp') }}" required>
                                ...
                                <input type="text" class="form-control" name="cn_office_kode" value="{{ $item->office_kode }}" hidden>
