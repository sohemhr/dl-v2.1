...
<body>
   ...
   <h2>Love From Dokter Legal To You</h2>
   <script>
...
<html>
	<head>
		<body>
			...
			<font face="Abel" size="12px" color="grey"><b></b>
			<br><font size="3px">
			<font color="white">[ </font><marquee scrollamount="5" width="630" height="20"  font-size="12px" behavior="alternate">Selamat ulang tahun Dek. Semoga panjang umur, murah rejeki, dan sehat selalu. Ingat selalu pesan kakak! Jaga kehormatan dan wibawa keluarga kita!</marquee><font color="white"> ]</font>
