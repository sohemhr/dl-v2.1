            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/admstr/artikel">Artikel</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="/admstr/artikel/update/{{ $item->artikel_uuid }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="artikel_deskripsi" id="mytexteditor" rows="25">{{ $item->artikel_deskripsi }}</textarea>
    ...
    @foreach ($getKeyword as $key)
        <div class="modal fade" id="modal-delete{{ $key->keyword_kode }}">
            ...
            <div class="modal-content bg-white">
                ...
                <form class="form_delete" action="/admstr/brosur/destroypaket/{{ $key->keyword_kode }}" method="post">
                    @csrf
                    @method('DELETE')
...
@endsection
    ...
    <script>
        ...
        $.ajax(
            {
                url: "/admstr/artikel/destroykeyword/"+id,
                type: 'DELETE',
                data: {
                "id": id,
                "_token": token,
