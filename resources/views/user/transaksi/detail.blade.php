                        ...
                        <form class="form-horizontal" action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="trx_jumlah" class="form-control @error('trx_jumlah') is-invalid @enderror" id="trx_jumlah" placeholder="Nama Include" value="{{ Number::format($item->trx_jumlah) }}" type-currency="IDR" readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="trx_diskon" class="form-control @error('trx_diskon') is-invalid @enderror" id="trx_diskon" placeholder="Nama Include" value="{{ Number::format($item->trx_diskon) }}" type-currency="IDR" readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="trx_biaya_lain" class="form-control @error('trx_biaya_lain') is-invalid @enderror" id="trx_biaya_lain" placeholder="Nama Include" value="{{ Number::format($item->trx_biaya_lain) }}"  type-currency="IDR"readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="trx_total_bayar" class="form-control @error('trx_total_bayar') is-invalid @enderror" id="trx_total_bayar" placeholder="Nama Include" value="{{ Number::format($item->trx_total_bayar) }}" type-currency="IDR" readonly>
                        ...
                        <table id="example2" class="table table-bordered table-striped">
                            ...
                            @foreach ($getPembayaran as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admstr/transaksi/pembayaran/cetak/{{ $item->pembayaran_uuid }}" target="_blank">
                ...
                <div class="modal-dialog">
                    <div class="modal-content bg-white">
                        ...
                        <form class="form_delete" action="#" method="post">
                            ...
                            <button type="button" class="btn btn-sm btn-danger deleteRecord" data-id="{{ $key->pembayaran_uuid }}">
