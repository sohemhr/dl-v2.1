...
<html lang="id">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="/admstr/transaksi/store/{{ $item->perusahaan_uuid }}" method="post" enctype="multipart/form-data" name="myForm">
                            @csrf
                            <div class="card-body">
    ...
    <script>
        ...
        $.ajax(
            {
                url: "/admstr/transaksi/destroyjenis/"+id,
                type: 'DELETE',
                data: {
                "id": id,
                "_token": token,
