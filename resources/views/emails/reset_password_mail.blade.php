                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:18px;line-height:1;text-align:center;color:#555;">
                                                Sepertinya Anda lupa kata sandi Anda.
                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:128px;">
                                                            ...
                                                            <img height="auto" src="https://www.dokterlegal.co.id/assets/img/reset_icon.png" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="128" />
                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                <tr>
                                                    <td align="center" bgcolor="#2F67F6" role="presentation" style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;" valign="middle">
                                                        <a href="https://www.dokterlegal.co.id/my-forgot-password/reset-password/{{ $data['body'] }}" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:20px;text-align:center;color:#7F8FA4;">
                                                Jika Anda tidak membuat permintaan ini, abaikan saja email ini. Jika tidak, silakan klik tombol di atas untuk mengatur ulang kata sandi Anda.
                                            </div>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                    ...
                                                    <tr>
                                                        <td align="center" style="font-size:0px;padding:10px;word-break:break-word;">
                                                            ...
                                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;font-weight:300;line-height:1;text-align:center;color:#575757;">
                                                                <a href="https://www.dokterlegal.co.id" style="color:#575757"><b>www.dokterlegal.co.id</b></a>
                                                            </div>
