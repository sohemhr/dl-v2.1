                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:18px;line-height:1;text-align:center;color:#555;">
                                                CS {{ $data['user'] }} telah menambahkan Transaksi Baru.
                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:128px;">
                                                            ...
                                                            <img height="auto" src="https://www.dokterlegal.co.id/assets/img/newtrx_icon.png" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="128" />
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:20px;line-height:20px;text-align:center;color:#7F8FA4;">
                                                Terima Kasih.
                                            </div>
